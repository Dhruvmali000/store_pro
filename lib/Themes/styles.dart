...
abstract class Styles {
  ...
  static const TextStyle textStyleBoldWhite = TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w700,
    color: Colors.white,
  );
  ...
  static const TextStyle deliveryTextStyle = TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w400,
    color: Colors.black,
  );
  ...
  static const TextStyle textStyleWhiteBold = TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w700,
    color: Colors.white,
  );
  ...
  static TextStyle productRowItemName = const TextStyle(
    fontSize: 18,
